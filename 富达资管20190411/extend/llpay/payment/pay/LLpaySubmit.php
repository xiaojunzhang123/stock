...
class LLpaySubmit {
	...
	function ll_encrypt($json, $pubKey = null)
    {
        $pubKey = $pubKey ? : EXTEND_PATH . "llpay/payment/key/llpay_public_key.pem";
        return ll_encrypt($json, file_get_contents($pubKey));
    }
}
?>