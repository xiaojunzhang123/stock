...
//Route::any('/$','web/Index/index');
Route::any('login','index/Home/login');
Route::any('scanOrderDefer','index/Home/scanOrderDefer'); // 持仓
...
Route::group("user", function () {
    ...
    Route::any('certification', 'index/User/certification'); // 上传身份证页面
    Route::any('cert_update', 'index/User/cert_update'); // 上传身份证update
    Route::any('cert_insert', 'index/User/cert_insert'); // 上传身份证插表
});
...
Route::group("cron", function () {
	...
	Route::any('px', 'index/Cron/grabStockpx'); // 徘行
...
Route::group([], function() {
    ...
    Route::group("admin", function () {
        ...
        Route::group("user", function(){
			...
			Route::any('cert', 'admin/User/cert');  // 会员认证
			Route::any('certupdate', 'admin/User/certupdate');  // 会员认证更改状态
        });
        ...
        Route::group("record", function(){
			...
			Route::any('rechargelog', 'admin/Record/rechargelog'); //充值流水
